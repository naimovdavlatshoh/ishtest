...
class JobCard extends ConsumerWidget {
            ...
            child: Column(
              ...
              children: [
                    ...
                    ClipRRect(
                      ...
                      child: job.image != null && job.image!.isNotEmpty
                          ? Image.network(
                              ...
                              height: 52,
                              fit: BoxFit.cover,
                              errorBuilder: (context, error, stackTrace) => _jobLogoFallback(),
                            )
                          : _jobLogoFallback(),
                    ),
                ...
                Wrap(
                  ...
                  runSpacing: 6,
                  children: [
                    _buildTag(LucideIcons.mapPin, job.location, maxWidth: 220),
                    _buildTag(LucideIcons.briefcase, _getJobTypeName(job.jobType, l10n)),
                    if (job.isRemote)
                      _buildTag(LucideIcons.house, l10n.vacanciesFilterRemote, color: AppColors.success),
                  ],
                ),
  ...
  Widget _jobLogoFallback() {
    return Container(
      ...
      child: const Icon(LucideIcons.briefcase, color: AppColors.primary, size: 28),
    );
  }
