          ...
          children: [
            ...
            if (isSelected && onClear != null)
              GestureDetector(
                ...
                child: const Icon(LucideIcons.circleX, size: 14, color: Colors.white70),
              )
            else
              Icon(
    ...
    _showCustomDialog(
      ...
      content: (dialogContext) => Column(
        ...
        children: options.map((opt) => ListTile(
          ...
          trailing: current.jobType == opt ? const Icon(LucideIcons.circleCheck, color: AppColors.primary) : null,
          onTap: () {
        ...
        children: [
          TextField(
            ...
            decoration: InputDecoration(
              ...
              border: OutlineInputBorder(borderRadius: BorderRadius.circular(12)),
              prefixIcon: const Icon(LucideIcons.circleMinus, size: 20),
            ),
          ),
          ...
          TextField(
            ...
            decoration: InputDecoration(
              ...
              labelStyle: const TextStyle(fontSize: 14),
              border: OutlineInputBorder(borderRadius: BorderRadius.circular(12)),
              prefixIcon: const Icon(LucideIcons.circlePlus, size: 20),
            ),
          ),
        ],
      ),
