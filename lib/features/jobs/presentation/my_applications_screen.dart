      ...
      child: Column(
        ...
        children: [
          Container(
            ...
            child: const Icon(LucideIcons.fileText, size: 44, color: AppColors.primary),
          ),
              ...
              Row(
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: const Icon(LucideIcons.briefcase, color: Colors.white, size: 26),
                  ),
                        ...
                        Wrap(
                          ...
                          children: [
                            if (job?.location != null && job!.location.isNotEmpty)
                              _InfoChip(icon: LucideIcons.mapPin, text: job.location),
                            _InfoChip(
                  ...
                  // Arrow indicator
                  Icon(LucideIcons.chevronRight, size: 14, color: Colors.grey[300]),
                ],
              ),
                      ...
                      child: Container(
                        ...
                        child: _isWithdrawing
                            ...
                            : Row( // Removed const
                                ...
                                children: [
                                  const Icon(LucideIcons.trash2, size: 15, color: Color(0xFFDC2626)),
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                child: const Icon(LucideIcons.trash2, color: Color(0xFFDC2626), size: 30),
              ),
              const SizedBox(height: 16),
              Text(
