              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    Row(
                      children: [
                        const Icon(LucideIcons.listFilter, size: 20, color: AppColors.textSecondary),
                    ...
                    Row(
                      children: [
                        const Icon(LucideIcons.code, size: 18, color: AppColors.textSecondary),
                        const SizedBox(width: 8),
                        Text(
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            children: [
              const Icon(LucideIcons.phone, size: 18, color: AppColors.textTertiary),
              const SizedBox(width: 10),
