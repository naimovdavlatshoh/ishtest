      ...
      child: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              children: [
                const Icon(LucideIcons.zap, size: 18, color: Color(0xFFF59E0B)),
  ...
  Widget build(BuildContext context) {
    final List<_QuickActionData> actions = [
      _QuickActionData(
        ...
        title: l10n.feedActionJobs,
        subtitle: l10n.feedActionJobsHint,
      ...
      _QuickActionData(
        ...
        title: l10n.feedActionExperts,
        subtitle: l10n.feedActionExpertsHint,
      ...
      _QuickActionData(
        ...
        subtitle: l10n.feedActionProfileHint,
        onTap: () => context.go('/profile/me'),
      ),
      _QuickActionData(
        ...
        title: l10n.feedActionServices,
        subtitle: l10n.feedActionServicesHint,
      ...
      _QuickActionData(
        ...
        title: l10n.feedActionPosts,
        subtitle: l10n.feedActionPostsHint,
      ...
      _QuickActionData(
        ...
        title: l10n.drawerMyResume,
        subtitle: l10n.feedActionResumeHint,
        onTap: () => context.push('/profile/edit', extra: 'Rezyume'),
      ),
    ];
          ...
          IntrinsicHeight(
            child: Row(
              ...
              children: [
                ...
                const SizedBox(width: 12),
                Expanded(child: _QuickActionCard(data: actions[i + 1])),
              ],
            ),
          ),
        ],
          ...
          child: Column(
            children: [
              ...
              Text(
                ...
                style: AppTextStyles.bodyMedium.copyWith(fontWeight: FontWeight.w700, height: 1.2),
              ),
              const SizedBox(height: 4),
              Text(
                data.subtitle,
