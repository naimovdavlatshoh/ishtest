...
class ConversationListNotifier extends StateNotifier<ConversationListState> {
  ...
  Future<void> load() async {
    ...
    try {
      ...
      final http.Response response = await ApiClient.get(Uri.parse(url), headers: await _headers());
...
class ChatRoomNotifier extends StateNotifier<ChatRoomState> {
  ...
  Future<void> initialize() async {
    ...
    try {
      ...
      final http.Response convResp = await ApiClient.get(Uri.parse(convUrl), headers: headers);
      ConversationModel? conversation;
      ...
      final http.Response msgResp = await ApiClient.get(Uri.parse(msgUrl), headers: headers);
      List<MessageModel> messages = [];
