...
class _ReceivedTab extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    if (state.received.isEmpty) {
      return _buildEmpty(l10n.invitationsEmptyReceived, LucideIcons.mailWarning);
    }
...
class _SentTab extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    if (state.sent.isEmpty) {
      return _buildEmpty(l10n.invitationsEmptySent, LucideIcons.send);
    }
    return RefreshIndicator(
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    children: [
                      Icon(LucideIcons.send, size: 12, color: Colors.grey[400]),
                      const SizedBox(width: 4),
                      Text(
                      ...
                      builder: (ctx) => GestureDetector(
                        ...
                        child: Container(
                          ...
                          child: Row(
                            ...
                            children: [
                              const Icon(LucideIcons.messageCircle, color: Colors.white, size: 15),
                              const SizedBox(width: 6),
