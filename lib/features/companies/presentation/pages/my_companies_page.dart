              ...
              Expanded(
                child: Center(
                  child: Column(
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: [
                      const Icon(LucideIcons.building2, size: 80, color: AppColors.textTertiary),
                      const SizedBox(height: 16),
                      Text(
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              Container(
                ...
                child: const Icon(LucideIcons.building2, color: AppColors.primary, size: 30),
              ),
          ...
          Wrap(
            ...
            children: [
              _buildSmallIconText(LucideIcons.mapPin, company.location),
              _buildSmallIconText(LucideIcons.users, l10n.myCompaniesEmployeesCount(company.size)),
              
              TextButton.icon(
                onPressed: () => context.go('/jobs/add', extra: {'companyId': company.id}),
                icon: const Icon(LucideIcons.circlePlus, size: 18, color: AppColors.primary),
                label: Text(
