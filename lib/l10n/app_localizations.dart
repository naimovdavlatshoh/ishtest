...
abstract class AppLocalizations {
  ...
  /// No description provided for @feedActionJobs.
  ///
  /// In uz, this message translates to:
  /// **'Ishlar'**
  String get feedActionJobs;

  /// No description provided for @feedActionJobsHint.
  ///
  /// In uz, this message translates to:
  /// **'Mos ish toping'**
  String get feedActionJobsHint;

  /// No description provided for @feedActionExperts.
  ///
  /// In uz, this message translates to:
  /// **'Mutaxassislar'**
  String get feedActionExperts;

  /// No description provided for @feedActionExpertsHint.
  ///
  /// In uz, this message translates to:
  /// **'Mutaxassis qidiring'**
  String get feedActionExpertsHint;

  /// No description provided for @feedActionProfileHint.
  ///
  /// In uz, this message translates to:
  /// **'Ma\'lumot va ko\'nikmalar qo\'shing'**
  String get feedActionProfileHint;

  /// No description provided for @feedActionServices.
  ///
  /// In uz, this message translates to:
  /// **'Xizmatlar'**
  String get feedActionServices;

  /// No description provided for @feedActionServicesHint.
  ///
  /// In uz, this message translates to:
  /// **'Xizmat taklif qiling yoki toping'**
  String get feedActionServicesHint;

  /// No description provided for @feedActionPosts.
  ///
  /// In uz, this message translates to:
  /// **'Postlar'**
  String get feedActionPosts;

  /// No description provided for @feedActionPostsHint.
  ///
  /// In uz, this message translates to:
  /// **'Postlarni o\'qing va ulashing'**
  String get feedActionPostsHint;

  /// No description provided for @feedActionResumeHint.
  ///
  /// In uz, this message translates to:
  /// **'Rezyume yuklang yoki yangilang'**
  String get feedActionResumeHint;
  ...
  ///
  /// In uz, this message translates to:
  /// **'998901234567 yoki email@mail.com'**
  ...
  /// No description provided for @forgotPasswordCodeSentMsg.
  ///
  /// In uz, this message translates to:
  /// **'Tasdiqlash kodi {email} manziliga yuborildi'**
  ...
  /// No description provided for @forgotPasswordConfirmNewPasswordLabel.
  ///
  /// In uz, this message translates to:
  /// **'Yangi parolni tasdiqlang'**
  String get forgotPasswordConfirmNewPasswordLabel;

  /// No description provided for @forgotPasswordConfirmNewPasswordHint.
  ///
  /// In uz, this message translates to:
